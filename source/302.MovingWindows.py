...
data = pyupbit.get_ohlcv(ticker=ticker, interval='day', count=200)
# data = pyupbit.get_ohlcv(ticker=ticker, interval='day', count=100)
# data = pyupbit.get_ohlcv(ticker=ticker, interval='minutes1', count=116)
# print(data)
