...
while True:
    try:
        ...
        orderPrice = round(currentPrice, 1)
        orderCount = int(amountPerBuy/currentPrice)
    
        # 지정가 매수 : buy_limit_order(티커 이름, 주문할 가격, 수량)
        buyResult = upbit.buy_limit_order(ticker=ticker, price=orderPrice, volume=orderCount)
...
# print("\n\n=======  sell order  ======================")
# print(f"## Sell Result: ", sell_result['uuid'], "\n")
# print(f"{sell_result}\n\n")
